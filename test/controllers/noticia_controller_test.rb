...
class NoticiaControllerTest < ActionController::TestCase
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post :create, noticium: { img: @noticium.img, texto: @noticium.texto, titulo: @noticium.titulo, utilizador_id: @noticium.utilizador_id }
    end
  ...
  test "should update noticium" do
    patch :update, id: @noticium, noticium: { img: @noticium.img, texto: @noticium.texto, titulo: @noticium.titulo, utilizador_id: @noticium.utilizador_id }
    assert_redirected_to noticium_path(assigns(:noticium))
  end
