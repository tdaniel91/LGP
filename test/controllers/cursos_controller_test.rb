...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { ano: @curso.ano, nome: @curso.nome, univ: @curso.univ, utilizador_id: @curso.utilizador_id }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { ano: @curso.ano, nome: @curso.nome, univ: @curso.univ, utilizador_id: @curso.utilizador_id }
    assert_redirected_to curso_path(assigns(:curso))
  end
